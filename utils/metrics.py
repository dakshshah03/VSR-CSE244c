...
def main():
    ...
    avg_ssim, ssim_scores = ssim_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'baseline'))
    print(f"Mean score: {avg_ssim}")
    print(f"All scores: {ssim_scores}")
    print()

    print('Comparing ground truth and realesr ssim')
    avg_ssim, ssim_scores = ssim_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'realesr'))
    print(f"Mean score: {avg_ssim}")
    print(f"All scores: {ssim_scores}")
    print()

    print('Comparing ground truth and stablevsr ssim')
    avg_ssim, ssim_scores = ssim_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'stablevsr'))
    print(f"Mean score: {avg_ssim}")
    print(f"All scores: {ssim_scores}")
    print()

    print('Comparing ground truth and baseline psnr')
    avg_psnr, psnr_scores = psnr_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'baseline'))
    print(f"Mean score: {avg_psnr}")
    print(f"All scores: {psnr_scores}")
    print()

    print('Comparing ground truth and realesr psnr')
    avg_psnr, psnr_scores = psnr_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'realesr'))
    print(f"Mean score: {avg_psnr}")
    print(f"All scores: {psnr_scores}")
    print()

    print('Comparing ground truth and stablevsr psnr')
    avg_psnr, psnr_scores = psnr_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'stablevsr'))
    print(f"Mean score: {avg_psnr}")
    print(f"All scores: {psnr_scores}")
    print()

    print('Comparing ground truth and baseline lpips')
    avg_lpips, lpips_scores = lpips_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'baseline'))
    print(f"Mean score: {avg_lpips}")
    print(f"All scores: {lpips_scores}")
    print()

    print('Comparing ground truth and realesr lpips')
    avg_lpips, lpips_scores = lpips_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'realesr'))
    print(f"Mean score: {avg_lpips}")
    print(f"All scores: {lpips_scores}")
    print()

    print('Comparing ground truth and stablevsr lpips')
    avg_lpips, lpips_scores = lpips_video(os.path.join('data', 'benchmark_data', 'ground_truth'), os.path.join('output', 'stablevsr'))
    print(f"Mean score: {avg_lpips}")
    print(f"All scores: {lpips_scores}")
    print()

    print('Calculating baseline tlpips')
    avg_tlpips, tlpips_scores = tlpips_video(os.path.join('output', 'baseline'))
    print(f"Mean score: {avg_tlpips}")
    print(f"All scores: {tlpips_scores}")
    print()

    print('Calculating realesr tlpips')
    avg_tlpips, tlpips_scores = tlpips_video(os.path.join('output', 'realesr'))
    print(f"Mean score: {avg_tlpips}")
    print(f"All scores: {tlpips_scores}")
    print()

    print('Calculating stablevsr tlpips')
    avg_tlpips, tlpips_scores = tlpips_video( os.path.join('output', 'stablevsr'))
    print(f"Mean score: {avg_tlpips}")
    print(f"All scores: {tlpips_scores}")
    print()
